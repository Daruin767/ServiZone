...
class _HomeClientScreenState extends State<HomeClientScreen>
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              const Text('No hay actividad reciente', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: darkGray)),
  ...
  Widget _buildSolicitudScreen() {
    final filteredCategories = categories.where((c) => c["title"].toLowerCase().contains(searchQuery.toLowerCase())).toList();
            ...
            child: Column(
              children: [
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                const Text('Agregar dirección', style: TextStyle(fontWeight: FontWeight.w600, color: darkGray)),
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      const Text('Categorías de Servicios', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: darkGray)),
                      const Spacer(),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Spacer(),
              Text(category["title"], style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
